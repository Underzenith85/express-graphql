...
function graphqlHTTP(options) {
  ...
  return function (request, response) {
    ...
    new Promise(function (resolve, reject) {
      ...
      if (showGraphiQL) {
        response.set('Content-Type', 'text/html').send((0, _renderGraphiQL.renderGraphiQL)({ query: query, variables: variables, operationName: operationName, result: result, backendServer: backendServer }));
      } else {
